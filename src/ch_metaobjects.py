...
class MetaObjectStore(object):
    def __init__(self):
        ...
        # request data
        self.site_json  = museum.site_information()
        self.df_departments = museum.site_departments()
        self.df_exhibitions_acquired = museum.site_exhibitions()
    ...
    def attach_meta(self):
        ...
        #self.df_objects_meta[cols] = self.df_objects_meta[cols].astype(int)
